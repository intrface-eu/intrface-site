...
export default async function AocPage() {
          ...
          <div className="grid gap-10 lg:grid-cols-[0.9fr_1.2fr] lg:gap-14">
            ...
            <div className="rounded-2xl border border-rule bg-card p-6">
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <a href={aocLinks.docs} target="_blank" className="inline-flex items-center justify-center rounded-md border border-rule bg-background px-4 py-2 text-sm font-medium text-foreground hover:bg-panel">
                  {t("quickStart.docsCta")}
                </a>
                <a href={aocLinks.github} target="_blank" className="inline-flex items-center justify-center rounded-md border border-rule bg-background px-4 py-2 text-sm font-medium text-foreground hover:bg-panel">
        ...
        <div className="section-shell py-16 sm:py-20">
          <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-end">
            ...
            <div className="flex flex-col gap-3 lg:items-start">
              <a href={aocLinks.github} target="_blank" className="inline-flex items-center justify-center rounded-md bg-background px-5 py-3 text-sm font-medium text-foreground transition-opacity hover:opacity-90">
                {t("finalCta.primaryCta")}
              </a>
              <a href={aocLinks.docs} target="_blank" className="inline-flex items-center justify-center rounded-md border border-background/20 px-5 py-3 text-sm font-medium text-background transition-colors hover:border-background/40 hover:bg-background/6">
